(* OASIS_START *)
(* DO NOT EDIT (digest: d0115297c019ab7630c3925b55266d87) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("eliom-widgets.client", ["src"; "src/_client"]);
          ("eliom-widgets.server", ["src"; "src/_server"])
       ];
     lib_c = [];
     flags = [];
     includes =
